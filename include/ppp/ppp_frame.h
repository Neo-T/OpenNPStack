 ...
 *
 * Author：Neo-T, Created in 2022.03.21 14:04
 *
...
//* ===============================================================================================
#define ACCM_BYTES	32	//* 需要转义的ACCM控制字符的数量
...
//* Echo Request
PACKED_BEGIN
typedef struct _ST_LCP_ECHO_REQ_HDR_ {
	UINT unLocalMagicNum; 
} PACKED ST_LCP_ECHO_REQ_HDR, *PST_LCP_ECHO_REQ_HDR;
PACKED_END

//* Echo Reply
PACKED_BEGIN
typedef struct _ST_LCP_ECHO_REPLY_HDR_ {
	UINT unLocalMagicNum;
	UINT unRemoteMagicNum;
} PACKED ST_LCP_ECHO_REPLY_HDR, *PST_LCP_ECHO_REPLY_HDR;
PACKED_END
